...
pdf("decoded_syms.pdf", onefile = TRUE,width=10,height=7)
...
decoded <- decoded + theme_complete_bw()
decoded <- decoded + scale_fill_manual(values = c("#f4a582","#ca0020", "#bababa", "#ffffff", "#000000"))
print(decoded)
