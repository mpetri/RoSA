...
pdf("percent_decoded.pdf", onefile = TRUE,width=10,height=7)
...
percent_decoded <- percent_decoded + theme_complete_bw()
percent_decoded <- percent_decoded + scale_fill_manual(values = c("#f4a582","#ca0020", "#bababa", "#ffffff", "#000000"))
print(percent_decoded)
