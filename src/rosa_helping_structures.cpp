...
block_info::block_info(size_type bwd_lb, size_type depth, size_type fwd_lb,
                       size_type size)
...
block_node::block_node(size_type delta_x, size_type delta_d,
                       size_type dest_block, size_type bwd_id)
    : delta_x(delta_x), delta_d(delta_d), dest_block(dest_block), bwd_id(bwd_id)
{
}

bwd_block_info::bwd_block_info(size_type bwd_lb, size_type bwd_rb,
                               size_type depth, size_type block_id)
...
{
    out << "{" << x.bwd_id << "," << x.delta_x << "," << x.delta_d << "}"
        << std::endl;
    return out;
}
